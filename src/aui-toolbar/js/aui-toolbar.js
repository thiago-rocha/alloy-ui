...
var isFunction = A.Lang.isFunction,
    ...
    CSS_BTN_TOOLBAR = A.getClassName('btn', 'toolbar', 'buttom');
    ...
    prototype: {
        ...
        bindUI: function() {
            ...
            boundingBox.delegate(
                ['click', 'mousemove', 'focus'], this._onUserInitInteraction, '.' + CSS_BTN_TOOLBAR,
                this);
        },
        ...
        _initEnclosingWidgetIfNeeded: function(seed, event) {
            ...
            buttonNode = seed.ancestor('.' + CSS_BTN_TOOLBAR, true);
