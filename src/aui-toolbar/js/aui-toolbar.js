...
var Lang = A.Lang,
    ...
    CSS_BTN_TOOLBAR = getCN('btn', 'toolbar', 'buttom');
    ...
    prototype: {
        ...
        bindUI: function() {
            ...
            boundingBox.delegate(
                ['click', 'mousemove', 'focus'], instance._onUserInitInteraction, '.' + CSS_BTN_TOOLBAR,
                instance);
        },
        ...
        _initEnclosingWidgetIfNeeded: function(seed, event) {
            ...
            var buttonNode = seed.ancestor('.' + CSS_BTN_TOOLBAR, true);
