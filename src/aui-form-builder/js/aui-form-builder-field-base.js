...
var L = A.Lang,
    ...
    TPL_FLAG_REQUIRED = '<span class="' + [CSS_GLYPHICON, CSS_ICON_ASTERISK].join(SPACE) + '"></span>',
    TPL_FLAG_TIP = '<span class="' + [CSS_GLYPHICON, CSS_ICON_QUESTION_SIGN].join(SPACE) + '"></span>',
