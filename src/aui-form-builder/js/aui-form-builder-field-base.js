...
var CSS_FIELD = A.getClassName('form', 'builder', 'field'),
    ...
    TPL_FIELD_CONFIGURATION = '<button class="btn btn-default ' + CSS_FIELD_CONFIGURATION + '">' +
...
A.FormBuilderFieldBase = A.Base.create('form-builder-field-base', A.Base, [], {
    ...
    /**
     * Toggles the Configuration Button of Form Field Base by adding or removing the active class name.
     *
