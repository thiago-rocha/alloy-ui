YUI.add('aui-layout-builder-add-col-tests', function(Y) {
    ...
    suite.add(new Y.Test.Case({
        ...
        'should enable/disable adding columns dynamically': function() {
            ...
            breakpoint = col.ancestor().all('.' + CSS_RESIZE_COL_BREAKPOINT).item(1);
        ...
        'should normalize cols height after add a new col': function() {
            ...
            breakpoint = row.get('node').all('.' + CSS_RESIZE_COL_BREAKPOINT).item(11);
        ...
        'should insert a new column on the left after drop the left draggable handle': function() {
            ...
            breakpoint = row.get('node').all('.' + CSS_RESIZE_COL_BREAKPOINT).item(1);
        ...
        //here
        'should cancel add column dropping on first breakpoint': function() {

        },

        //here
        'should cancel add column dropping on last breakpoint': function() {
